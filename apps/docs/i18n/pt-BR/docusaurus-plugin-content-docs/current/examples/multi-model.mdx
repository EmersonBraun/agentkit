...
Compare respostas de diferentes modelos de IA lado a lado. Mesma entrada, adaptadores diferentes — o AgentsKit torna isso trivial.

<MultiModelChat />

## Com o AgentsKit

Basta usar dois hooks `useChat` com adaptadores diferentes:
