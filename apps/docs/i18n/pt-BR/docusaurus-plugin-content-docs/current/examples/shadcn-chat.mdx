...
O hook `useChat` do AgentsKit estilizado com padrões shadcn/ui. Esta demo recria o visual shadcn — num app real, você usaria componentes shadcn de fato.

<ShadcnChat />

## Com shadcn/ui de verdade
