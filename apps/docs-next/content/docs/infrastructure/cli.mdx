---
title: CLI
description: "@agentskit/cli — interactive chat, one-shot agent runs, starter projects, and a full extensibility surface (plugins, hooks, permissions, MCP, RAG, sessions, telemetry)."
---
...
[Start here](../getting-started/read-this-first) · [Packages](../packages/overview) · [Quick Start](../getting-started/quickstart) · [Ink](../chat-uis/ink) · [Runtime](../agents/runtime) · [Eval](./eval) · [ARCHITECTURE.md](https://github.com/AgentsKit-io/agentskit/blob/main/packages/cli/ARCHITECTURE.md)

<ContributeCallout pkg="cli" />
