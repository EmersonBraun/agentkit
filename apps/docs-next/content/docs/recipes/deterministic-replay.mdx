...
- [Prompt snapshot testing](/docs/recipes/prompt-snapshots) — assert prompts stay stable
- [Prompt diff](/docs/recipes/prompt-diff) — attribute output changes to prompt changes
- [Eval suite](/docs/recipes/eval-suite) — score agents in CI
