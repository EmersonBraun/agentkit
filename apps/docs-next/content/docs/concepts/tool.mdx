...
The full list of invariants (twelve of them, T1–T12) is in [ADR 0002 — Tool contract](https://github.com/EmersonBraun/agentskit/blob/main/docs/architecture/adrs/0002-tool-contract.md).
