...
The full list of invariants (eleven of them, R1–R11) is in [ADR 0004 — Retriever contract](https://github.com/EmersonBraun/agentskit/blob/main/docs/architecture/adrs/0004-retriever-contract.md).
