...
The full list of invariants (six for ChatMemory, eight for VectorMemory, three for EmbedFn) is in [ADR 0003 — Memory contract](https://github.com/EmersonBraun/agentskit/blob/main/docs/architecture/adrs/0003-memory-contract.md).
