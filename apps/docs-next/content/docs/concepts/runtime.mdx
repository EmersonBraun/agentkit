...
The full list of invariants (fourteen of them, RT1–RT14) is in [ADR 0006 — Runtime contract](https://github.com/EmersonBraun/agentskit/blob/main/docs/architecture/adrs/0006-runtime-contract.md).
