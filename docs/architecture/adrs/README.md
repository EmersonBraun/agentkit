...
The 6 core contracts are now formalized. Future ADRs will cover specific decisions (Fumadocs migration, semver policy, licensing strategy, etc.) rather than additional foundational contracts.
